...
export default function Home() {
  ...
  function mensagemDelete(id) {
    Alert.alert("Excluir Registro", "Deseja excluir este sinal?", [
        ...
        >
          ...
          <View style={{ padding: 16 }}>
            <Text style={{ fontSize: 16, color: "#000" }}>
              Total de sinais cadastrados: {total.total_usuarios}
            </Text>
          </View>

          <View style={{ alignItems: "center", marginVertical: 20 }}>
            <Image
              source={require("../../../assets/ia.png")} // substitua pelo caminho da sua imagem
